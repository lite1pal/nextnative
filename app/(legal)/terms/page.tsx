  ...
  return (
    <div className="prose dark:prose-invert max-w-xl mx-auto">
      ...
      <p>
        ...
        in its sole discretion, it deems appropriate, including removing the
      ...
      <p>
        The laws of <strong>Ukraine</strong>, excluding its conflicts of law
      ...
      <ul>
        <li>
          ...
          <a href="nextnative.dev" target="_blank" rel="noopener noreferrer">
            nextnative.dev
          </a>
        </li>
        <li>
