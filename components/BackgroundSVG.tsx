...
function BackgroundSVG() {
  ...
  return (
    <div className="absolute top-0 left-0 z-[-1] grid h-full w-full max-w-[100vw] grid-rows-6 overflow-hidden">
      <svg
        id="background-svg"
        width="100%"
        height="100%"
        ...
        className={`${pathName !== "/" ? "row-span-6" : "row-span-4"} h-full w-full max-w-[100vw]`}
      >
      ...
      {pathName === "/" && (
        <div
          className="relative -top-1 row-span-2 h-full w-full"
          style={{
